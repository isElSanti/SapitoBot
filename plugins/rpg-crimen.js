...
text: `${emoji} Robaste *${amountTaken} ${moneda} 💸* a @${randomUserId.split("@")[0]}\n\nSe suman *+${amountTaken} ${moneda} 💸* a ${senderName}.`,
contextInfo: { 
...
conn.reply(m.chat, `${emoji2} No fuiste cuidadoso y te atraparon mientras cometias un crimen, se restaron *-${amountSubtracted} ${moneda} 💸* a ${senderName}.`, m)
break
case 2:
...
conn.sendMessage(m.chat, {
text: `${emoji} Lograste cometer un crimen con exito, pero te descubrieron y solo lograste tomar *${smallAmountTaken} ${moneda} 💸* de @${randomUserId.split("@")[0]}\n\nSe suman *+${smallAmountTaken} ${moneda} 💸* a ${senderName}.`,
contextInfo: { 
mentionedJid: [randomUserId],
}}, { quoted: m })
break
